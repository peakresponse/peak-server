...
if (process.env.AWS_S3_ENDPOINT) {
  ...
  if (process.env.AWS_S3_ACCESS_KEY_ID) {
    ...
    options.credentials.accessKeyId = process.env.AWS_S3_ACCESS_KEY_ID;
  }
  if (process.env.AWS_S3_SECRET_ACCESS_KEY) {
    options.credentials = options.credentials || {};
    options.credentials.secretAccessKey = process.env.AWS_S3_SECRET_ACCESS_KEY;
  }
  if (process.env.AWS_S3_BUCKET_REGION) {
    options.region = process.env.AWS_S3_BUCKET_REGION;
  }
