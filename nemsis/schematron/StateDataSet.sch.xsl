...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sNilNvPn</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Nil/Not Value Attributes</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sNvPn</xsl:attribute>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_StateDataSet</xsl:attribute>
            <xsl:attribute name="name">StateDataSet</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sdCustomConfiguration</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Demographic Custom Elements</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_seCustomConfiguration</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Patient Care Report Custom Elements</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sElement</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / State Collected Elements</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sConfiguration</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Configuration Information</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sAgency</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Agency Information</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">nemSch_sFacility</xsl:attribute>
            <xsl:attribute name="name">StateDataSet / Facility Information</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">NEMSIS National ISO Schematron file for StateDataSet</svrl:text>
   ...
   <!--PATTERN nemSch_sNilNvPnStateDataSet / Nil/Not Value Attributes-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Nil/Not Value Attributes</svrl:text>
   <!--RULE nemSch_sNilNvPn_rule_1-->
   <xsl:template match="*[@xsi:nil = 'true']" priority="1001" mode="M9">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@xsi:nil = 'true']"
                       id="nemSch_sNilNvPn_rule_1"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@NV">
               <xsl:attribute name="id">nemSch_s001</xsl:attribute>
   ...
   <!--RULE nemSch_sNilNvPn_rule_2-->
   <xsl:template match="*[@NV]" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@NV]"
                       id="nemSch_sNilNvPn_rule_2"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@xsi:nil='true'">
               <xsl:attribute name="id">nemSch_s002</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">nemSch_s003</xsl:attribute>
   ...
   <!--PATTERN nemSch_StateDataSetStateDataSet-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet</svrl:text>
   <!--RULE nemSch_StateDataSet_rule_1-->
   <xsl:template match="nem:StateDataSet" priority="1000" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:StateDataSet"
                       id="nemSch_StateDataSet_rule_1"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">nemSch_s004</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
      The timestamp of the StateDataSet should not be in the future (the current time according to this system is <xsl:text/>
   ...
   <!--PATTERN nemSch_sdCustomConfigurationStateDataSet / Demographic Custom Elements-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Demographic Custom Elements</svrl:text>
   <!--RULE nemSch_sdCustomConfiguration_rule_1-->
   <xsl:template match="nem:sdCustomConfiguration.CustomGroup"
                 priority="1003"
                 mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sdCustomConfiguration.CustomGroup"
                       id="nemSch_sdCustomConfiguration_rule_1"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(@CustomElementID) = preceding-sibling::nem:sdCustomConfiguration.CustomGroup/normalize-space(@CustomElementID))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(@CustomElementID) = preceding-sibling::nem:sdCustomConfiguration.CustomGroup/normalize-space(@CustomElementID))">
               <xsl:attribute name="id">nemSch_s005</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_sdCustomConfiguration_rule_2-->
   <xsl:template match="nem:sdCustomConfiguration.06" priority="1002" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sdCustomConfiguration.06"
                       id="nemSch_sdCustomConfiguration_rule_2"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:sdCustomConfiguration.06/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:sdCustomConfiguration.06/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s006</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same value should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
      ...
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(@customValueDescription) = preceding-sibling::nem:sdCustomConfiguration.06/normalize-space(@customValueDescription))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(@customValueDescription) = preceding-sibling::nem:sdCustomConfiguration.06/normalize-space(@customValueDescription))">
               <xsl:attribute name="id">nemSch_s007</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
      The Custom Value Description for <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same description should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sdCustomConfiguration_rule_3-->
   <xsl:template match="nem:sdCustomConfiguration.07" priority="1001" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sdCustomConfiguration.07"
                       id="nemSch_sdCustomConfiguration_rule_3"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:sdCustomConfiguration.07)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:sdCustomConfiguration.07)">
               <xsl:attribute name="id">nemSch_s008</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_sdCustomConfiguration_rule_4-->
   <xsl:template match="nem:sdCustomConfiguration.08" priority="1000" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sdCustomConfiguration.08"
                       id="nemSch_sdCustomConfiguration_rule_4"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:sdCustomConfiguration.08)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:sdCustomConfiguration.08)">
               <xsl:attribute name="id">nemSch_s009</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN nemSch_seCustomConfigurationStateDataSet / Patient Care Report Custom Elements-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Patient Care Report Custom Elements</svrl:text>
   <!--RULE nemSch_seCustomConfiguration_rule_1-->
   <xsl:template match="nem:seCustomConfiguration.CustomGroup"
                 priority="1003"
                 mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:seCustomConfiguration.CustomGroup"
                       id="nemSch_seCustomConfiguration_rule_1"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(@CustomElementID) = preceding-sibling::nem:seCustomConfiguration.CustomGroup/normalize-space(@CustomElementID))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(@CustomElementID) = preceding-sibling::nem:seCustomConfiguration.CustomGroup/normalize-space(@CustomElementID))">
               <xsl:attribute name="id">nemSch_s010</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_seCustomConfiguration_rule_2-->
   <xsl:template match="nem:seCustomConfiguration.06" priority="1002" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:seCustomConfiguration.06"
                       id="nemSch_seCustomConfiguration_rule_2"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:seCustomConfiguration.06/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:seCustomConfiguration.06/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s011</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(@customValueDescription) = preceding-sibling::nem:seCustomConfiguration.06/normalize-space(@customValueDescription))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(@customValueDescription) = preceding-sibling::nem:seCustomConfiguration.06/normalize-space(@customValueDescription))">
               <xsl:attribute name="id">nemSch_s012</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_seCustomConfiguration_rule_3-->
   <xsl:template match="nem:seCustomConfiguration.07" priority="1001" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:seCustomConfiguration.07"
                       id="nemSch_seCustomConfiguration_rule_3"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:seCustomConfiguration.07)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:seCustomConfiguration.07)">
               <xsl:attribute name="id">nemSch_s013</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_seCustomConfiguration_rule_4-->
   <xsl:template match="nem:seCustomConfiguration.08" priority="1000" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:seCustomConfiguration.08"
                       id="nemSch_seCustomConfiguration_rule_4"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:seCustomConfiguration.08)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:seCustomConfiguration.08)">
               <xsl:attribute name="id">nemSch_s014</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN nemSch_sElementStateDataSet / State Collected Elements-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / State Collected Elements</svrl:text>
   <!--RULE nemSch_sElement_rule_1-->
   <xsl:template match="nem:sElement.01" priority="1000" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sElement.01"
                       id="nemSch_sElement_rule_1"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:sElement.01/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:sElement.01/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s015</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same element should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--PATTERN nemSch_sConfigurationStateDataSet / Configuration Information-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Configuration Information</svrl:text>
   <!--RULE nemSch_sConfiguration_rule_1-->
   <xsl:template match="nem:sConfiguration.01" priority="1005" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.01"
                       id="nemSch_sConfiguration_rule_1"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:sConfiguration.01)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:sConfiguration.01)">
               <xsl:attribute name="id">nemSch_s016</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same level should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sConfiguration_rule_2-->
   <xsl:template match="nem:sConfiguration.02" priority="1004" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.02"
                       id="nemSch_sConfiguration_rule_2"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test=". = ../../nem:sConfiguration.01"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = ../../nem:sConfiguration.01">
               <xsl:attribute name="id">nemSch_s017</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be on the list of <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sConfiguration.01', $nemSch_elements)"/>
                  <xsl:text/>.
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
      ...
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(. = ../preceding-sibling::nem:sConfiguration.ProcedureGroup/nem:sConfiguration.02)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = ../preceding-sibling::nem:sConfiguration.ProcedureGroup/nem:sConfiguration.02)">
               <xsl:attribute name="id">nemSch_s018</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_sConfiguration_rule_3-->
   <xsl:template match="nem:sConfiguration.03" priority="1003" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.03"
                       id="nemSch_sConfiguration_rule_3"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:sConfiguration.03/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:sConfiguration.03/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s019</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same procedure should not be listed more than once for a particular level).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sConfiguration_rule_4-->
   <xsl:template match="nem:sConfiguration.04" priority="1002" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.04"
                       id="nemSch_sConfiguration_rule_4"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test=". = ../../nem:sConfiguration.01"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = ../../nem:sConfiguration.01">
               <xsl:attribute name="id">nemSch_s020</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(. = ../preceding-sibling::nem:sConfiguration.MedicationGroup/nem:sConfiguration.04)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = ../preceding-sibling::nem:sConfiguration.MedicationGroup/nem:sConfiguration.04)">
               <xsl:attribute name="id">nemSch_s021</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_sConfiguration_rule_5-->
   <xsl:template match="nem:sConfiguration.05" priority="1001" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.05"
                       id="nemSch_sConfiguration_rule_5"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:sConfiguration.05/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:sConfiguration.05/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s022</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same medication should not be listed more than once for a particular level).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
      ...
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test=". = '' or matches(., '^[0-9]{2,7}$') or not(@CodeType = '9924003')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = '' or matches(., '^[0-9]{2,7}$') or not(@CodeType = '9924003')">
               <xsl:attribute name="id">nemSch_s023</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test=". = '' or . = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000') or not(@CodeType = '9924005')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = '' or . = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000') or not(@CodeType = '9924005')">
               <xsl:attribute name="id">nemSch_s024</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT [ERROR]-->
      <xsl:choose>
         <xsl:when test=". = '' or matches(., '^[0-9]{2,7}$') or . = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000') or @CodeType"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=". = '' or matches(., '^[0-9]{2,7}$') or . = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000') or @CodeType">
               <xsl:attribute name="id">nemSch_s025</xsl:attribute>
               <xsl:attribute name="role">[ERROR]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE nemSch_sConfiguration_rule_6-->
   <xsl:template match="nem:sConfiguration.06" priority="1000" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sConfiguration.06"
                       id="nemSch_sConfiguration_rule_6"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:sConfiguration.06)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:sConfiguration.06)">
               <xsl:attribute name="id">nemSch_s026</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same protocol should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--PATTERN nemSch_sAgencyStateDataSet / Agency Information-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Agency Information</svrl:text>
   <!--RULE nemSch_sAgency_rule_1-->
   <xsl:template match="nem:sAgencyGroup" priority="1000" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sAgencyGroup"
                       id="nemSch_sAgency_rule_1"/>
      <xsl:variable name="nemsisElements" select="nem:sAgency.01, nem:sAgency.02"/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(preceding-sibling::nem:sAgencyGroup[nem:sAgency.01 = current()/nem:sAgency.01 and nem:sAgency.02 = current()/nem:sAgency.02])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(preceding-sibling::nem:sAgencyGroup[nem:sAgency.01 = current()/nem:sAgency.01 and nem:sAgency.02 = current()/nem:sAgency.02])">
               <xsl:attribute name="id">nemSch_s027</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sAgency.01', $nemSch_elements)"/>
                  <xsl:text/> and <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sAgency.02', $nemSch_elements)"/>
                  <xsl:text/> should be a unique combination for each EMS agency.
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--PATTERN nemSch_sFacilityStateDataSet / Facility Information-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">StateDataSet / Facility Information</svrl:text>
   <!--RULE nemSch_sFacility_rule_1-->
   <xsl:template match="nem:sFacility.FacilityGroup" priority="1003" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sFacility.FacilityGroup"
                       id="nemSch_sFacility_rule_1"/>
      <xsl:variable name="nemsisElements"
                    select="../nem:sFacility.01, nem:sFacility.03, nem:sFacility.07, nem:sFacility.08, nem:sFacility.09"/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(preceding::nem:sFacility.FacilityGroup[../nem:sFacility.01 = current()/../nem:sFacility.01 and normalize-space(nem:sFacility.03) = current()/normalize-space(nem:sFacility.03) and normalize-space(nem:sFacility.07) = current()/normalize-space(nem:sFacility.07) and normalize-space(nem:sFacility.08) = current()/nem:sFacility.08 and nem:sFacility.09 = current()/nem:sFacility.09])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(preceding::nem:sFacility.FacilityGroup[../nem:sFacility.01 = current()/../nem:sFacility.01 and normalize-space(nem:sFacility.03) = current()/normalize-space(nem:sFacility.03) and normalize-space(nem:sFacility.07) = current()/normalize-space(nem:sFacility.07) and normalize-space(nem:sFacility.08) = current()/nem:sFacility.08 and nem:sFacility.09 = current()/nem:sFacility.09])">
               <xsl:attribute name="id">nemSch_s028</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sFacility.01', $nemSch_elements)"/>
                  <xsl:text/>, <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sFacility.03', $nemSch_elements)"/>
                  <xsl:text/>, <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sFacility.07', $nemSch_elements)"/>
                  <xsl:text/>, <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sFacility.08', $nemSch_elements)"/>
                  <xsl:text/>, and <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'sFacility.09', $nemSch_elements)"/>
                  <xsl:text/> should be a unique combination for each facility.
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sFacility_rule_2-->
   <xsl:template match="nem:sFacility.04" priority="1002" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sFacility.04"
                       id="nemSch_sFacility_rule_2"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(. = preceding-sibling::nem:sFacility.04)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(. = preceding-sibling::nem:sFacility.04)">
               <xsl:attribute name="id">nemSch_s029</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same designation should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sFacility_rule_3-->
   <xsl:template match="nem:sFacility.05" priority="1001" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sFacility.05"
                       id="nemSch_sFacility_rule_3"/>
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="not(normalize-space(.) = preceding-sibling::nem:sFacility.05/normalize-space(.))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(normalize-space(.) = preceding-sibling::nem:sFacility.05/normalize-space(.))">
               <xsl:attribute name="id">nemSch_s030</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/>
                  <xsl:text/> should be unique (the same identifier should not be listed more than once).
    </svrl:text>
               <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
                  <nemsisDiagnostic xmlns="http://www.nemsis.org" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
                     <record>
   ...
   <!--RULE nemSch_sFacility_rule_4-->
   <xsl:template match="nem:sFacility.11" priority="1000" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="nem:sFacility.11"
                       id="nemSch_sFacility_rule_4"/>
      <xsl:variable name="nemsisElements" select="../nem:sFacility.09, ."/>
      <!--ASSERT [WARNING]-->
      <xsl:choose>
         <xsl:when test="starts-with(., ../nem:sFacility.09)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="starts-with(., ../nem:sFacility.09)">
               <xsl:attribute name="id">nemSch_s031</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
