module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      await queryInterface.addColumn('responders', 'departed_at', Sequelize.DATE, { transaction });
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query('ALTER TABLE responders ALTER COLUMN arrived_at DROP NOT NULL', { transaction });
      await queryInterface.removeConstraint('responders', 'responders_scene_id_user_id_arrived_at_uk', { transaction });
    });
  },
};
