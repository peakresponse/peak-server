...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.sequelize.createSchema('demographics', {transaction});
      ...
      await queryInterface.addConstraint('demographics.agencies', {type: 'UNIQUE', fields: ['agency_id'], transaction});
      await queryInterface.addConstraint('demographics.agencies', {type: 'UNIQUE', fields: ['subdomain'], transaction});
      ...
      await queryInterface.sequelize.query(`ALTER TABLE demographics.employments RENAME CONSTRAINT employments_created_by_id_fkey TO "demographics.employments_created_by_id_users_fk"`, {transaction});
      await queryInterface.sequelize.query(`ALTER TABLE demographics.employments RENAME CONSTRAINT employments_updated_by_id_fkey TO "demographics.employments_updated_by_id_users_fk"`, {transaction});
      await queryInterface.sequelize.query(`ALTER TABLE demographics.employments RENAME CONSTRAINT employments_user_id_fkey TO "demographics.employments_user_id_users_fk"`, {transaction});
      await queryInterface.sequelize.query(`
      ...
      await queryInterface.sequelize.query(`ALTER TYPE enum_employments__roles RENAME TO "enum_demographics.employments_roles"`, {transaction});
      ...
      await queryInterface.sequelize.query(`DELETE FROM demographics`, {transaction});
      ...
      await queryInterface.removeConstraint('agencies', 'agencies_state_uk', {transaction});
      ...
      await queryInterface.removeColumn('agencies', 'demographic_id', {transaction});
      await queryInterface.removeColumn('agencies', 'state_agency_id', {transaction});
      await queryInterface.sequelize.query(`DROP TYPE enum_agencies__type`, {transaction});
