...
describe('/api/utils', () => {
  ...
  describe('GET /geocode', () => {
    it('returns address components for a lat/lng', async () => {
      ...
      const client = agent.get('https://maps.googleapis.com');
      client
        .intercept({
          path: `/maps/api/geocode/json?key=${process.env.GOOGLE_MAPS_SERVER_API_KEY}&latlng=37.7782251%2C-122.4424955`,
          method: 'GET',
        })
        .reply(
          200,
