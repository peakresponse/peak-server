  ...
  describe('Responder', () => {
    ...
    describe('.assign()', () => {
      it('assigns a Role to a Responder', async () => {
        const user = await models.User.findByPk('ffc7a312-50ba-475f-b10f-76ce793dc62a', { rejectOnEmpty: true });
        const agency = await models.Agency.findByPk('9eeb6591-12f8-4036-8af8-6b235153d444', { rejectOnEmpty: true });

        const responder1 = await models.Responder.findByPk('c5fb3154-abec-49f2-af0b-bcd4c859510e', { rejectOnEmpty: true });
        assert.deepStrictEqual(responder1.role, null);
        let ids = await responder1.assign(user, agency, models.Responder.Roles.TRIAGE);
        ...
        const responder2 = await models.Responder.findByPk('5d0b9f69-7bd4-4674-a2ef-9e0afdc14705');
        ids = await responder2.assign(user, agency, models.Responder.Roles.TRIAGE);
        assert.deepStrictEqual(ids, ['c5fb3154-abec-49f2-af0b-bcd4c859510e', '5d0b9f69-7bd4-4674-a2ef-9e0afdc14705']);
    ...
    describe('.toJSON()', () => {
      it('returns the base JSON representation of a record', async () => {
        const responder = await models.Responder.findByPk('c5fb3154-abec-49f2-af0b-bcd4c859510e');
        assert(responder);
