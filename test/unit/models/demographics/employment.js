...
describe('models', function() {
  describe('Employment', function() {
    ...
    beforeEach(async function() {
      ...
      agency = await models.DemAgency.findByPk('9eeb6591-12f8-4036-8af8-6b235153d444');
    });

    describe('.save()', function() {
      it('generates an invitation code for new personnal', async function() {
    ...
    describe('.email', function() {
      it('also sets the Nemsis data elements when set directly', function() {
        const record = models.Employment.build();
    ...
    describe('.fullName', function() {
      it('parses out name parts from a string', function() {
        const record = models.Employment.build();
