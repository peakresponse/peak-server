<?xml version="1.0" encoding="UTF-8"?><?xml-stylesheet type="text/xsl" href="../utilities/html/schematronHtml.xsl"?><sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2" id="EMSDataSet" schemaVersion="3.5.0.251001CP6" see="https://nemsis.org/technical-resources/version-3/version-3-schematron/">
  ...
  <sch:rule id="nemSch_ePatient_rule_9" context="nem:ePatient[not(nem:ePatient.25[. != ''])]">

    <sch:let name="nemsisElements" value="nem:ePatient.25"/>
  ...
  <sch:rule id="nemSch_eDisposition_rule_14" context="nem:eDisposition.27">
    ...
    <sch:assert id="nemSch_e182" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eDisposition.30" test=". = '4227001' or ../nem:eDisposition.30 = ('', '4230011', '4230013')">
  ...
  <sch:rule id="nemSch_eDisposition_rule_18" context="nem:eDisposition.32[. = '' or . = '4232013']">
