...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:nem="http://www.nemsis.org" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA SETUP-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="NEMSIS National ISO Schematron file for EMSDataSet" schemaVersion="3.5.0.251001CP6">
         <xsl:comment>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">NEMSIS National ISO Schematron file for EMSDataSet</svrl:text>
   ...
   <xsl:variable xmlns:sch="http://purl.oclc.org/dsdl/schematron" name="nemSch_lookup_elements">
   ...
   <xsl:param name="nemSch_elements" select="$nemSch_lookup_elements//*:nemSch_lookup_elements"/>
...
<xsl:if test="false()">
      ...
      This rule enforces no constraints on the combination of xsi:nil, Not Value, and Pertinent Negative attributes on eCustomResults.01.
            ...
            <svrl:diagnostic-reference diagnostic="nemsisDiagnostic">
               <nemsisDiagnostic xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns="http://www.nemsis.org">
                  <record>
...
<xsl:template match="nem:eSituation.01[@PN = '8801023']" priority="1007" mode="M9">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
<xsl:choose>
         <xsl:when test="@xsi:nil = 'true' and not(@NV)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@xsi:nil = 'true' and not(@NV)">
...
<xsl:template match="nem:eSituation.01[@PN = '8801029']" priority="1006" mode="M9">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
<xsl:choose>
         <xsl:when test="not(@xsi:nil = 'true') and not(@NV)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(@xsi:nil = 'true') and not(@NV)">
...
<xsl:template match="nem:eExam.AssessmentGroup//*[@PN]" priority="1003" mode="M10">
      <xsl:variable name="nemsisElements" select="."/>
      <!--REPORT [WARNING]-->
<xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
...
<xsl:template match="*[@NV][local-name() = (local-name(preceding-sibling::*[1]), local-name(following-sibling::*[1]))]" priority="1001" mode="M10">
      <xsl:variable name="nemsisElements" select="../*[local-name() = local-name(current())]"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="false()"/>
         <xsl:otherwise>
...
<xsl:template match="*[@PN][local-name() = (local-name(preceding-sibling::*[1]), local-name(following-sibling::*[1]))]" priority="1000" mode="M10">
      <xsl:variable name="nemsisElements" select="../*[local-name() = local-name(current())]"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="false()"/>
...
<xsl:template match="nem:eResponse.01" priority="1005" mode="M11">
      <xsl:variable name="nemsisElements" select="., ancestor::nem:Header/nem:DemographicGroup/nem:dAgency.02"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test=". = ancestor::nem:Header/nem:DemographicGroup/nem:dAgency.02"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = ancestor::nem:Header/nem:DemographicGroup/nem:dAgency.02">
...
<xsl:template match="nem:eResponse.08[. = '2208013'][1]" priority="1004" mode="M11">
      <xsl:variable name="nemsisElements" select="../nem:eResponse.08"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eResponse.08) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eResponse.08) = 1">
...
<xsl:template match="nem:eResponse.09[. = '2209011'][1]" priority="1003" mode="M11">
      <xsl:variable name="nemsisElements" select="../nem:eResponse.09"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eResponse.09) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eResponse.09) = 1">
...
<xsl:template match="nem:eResponse.10[. = '2210017'][1]" priority="1002" mode="M11">
      <xsl:variable name="nemsisElements" select="../nem:eResponse.10"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eResponse.10) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eResponse.10) = 1">
...
<xsl:template match="nem:eResponse.11[. = '2211011'][1]" priority="1001" mode="M11">
      <xsl:variable name="nemsisElements" select="../nem:eResponse.11"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eResponse.11) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eResponse.11) = 1">
...
<xsl:template match="nem:eResponse.12[. = '2212015'][1]" priority="1000" mode="M11">
      <xsl:variable name="nemsisElements" select="../nem:eResponse.12"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eResponse.12) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eResponse.12) = 1">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.01 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.01)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.27 = '4227005'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.27 != '4227001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.06 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.06)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.07)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230003'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.09 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.09)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.11 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.11)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.18 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.18)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eTimes.12 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.12)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &lt;= current-dateTime() + xs:dayTimeDuration('PT1H')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="starts-with(., ../nem:ePatient.08)">
...
<xsl:template match="nem:ePatient.14[. = ''][1]" priority="1003" mode="M13">
      <xsl:variable name="nemsisElements" select="../nem:ePatient.14"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:ePatient.14 != '' or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:ePatient.14 != '' or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:template match="nem:ePatient.15[. = '']" priority="1002" mode="M13">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
...
<xsl:template match="nem:ePatient.16[. = '']" priority="1001" mode="M13">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
...
<xsl:choose>
   ...
   <!--RULE nemSch_ePatient_rule_9-->
<xsl:template match="nem:ePatient[not(nem:ePatient.25[. != ''])]" priority="1000" mode="M13">
      <xsl:variable name="nemsisElements" select="nem:ePatient.25"/>
      <xsl:variable name="nemsisElementsMissing" select=".[not(nem:ePatient.25)]/'ePatient.25'"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
               <xsl:attribute name="id">nemSch_e193</xsl:attribute>
               <xsl:attribute name="role">[WARNING]</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'ePatient.25', $nemSch_elements)"/>
                  <xsl:text/> should be recorded when <xsl:text/>
                  <xsl:value-of select="key('nemSch_key_elements', 'eDisposition.28', $nemSch_elements)"/>
                  <xsl:text/> is "Patient Evaluated and Care Provided".
    </svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = ('2707001', '2707005') or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.27 != '4227001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '2707001' or ../nem:eScene.07 != '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eScene.07 != '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="starts-with(., ../nem:eScene.18)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 != '2205001' or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". != '' or ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 != '2205001' or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '9922005' or not(some $element in ../(nem:eSituation.09, nem:eSituation.10, nem:eSituation.11, nem:eSituation.12) satisfies matches($element, '^(S|T(0\d|1[0-4]))'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eSituation.09 != ''">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eSituation.11 != ''">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001' or not(ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.01 = ('3001003', '3001005'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = ('2205005', '2205007', '2205015', '2205017', '2205019')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eInjury.01 != '' or ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 != '9922005' or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 = '9922005'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.01 = ('3001003', '3001005')) or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.01 = ('3001003', '3001005')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.03 != '' or not(../nem:eArrest.01 = ('3001003', '3001005')) or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.03 != '') or ../nem:eArrest.01 = ('3001003', '3001005')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.03 = ('3003001', '3003003', '3003005') and ../nem:eArrest.03 = ('3003007', '3003009', '3003011'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.03 = '3003005' or not(../nem:eArrest.09 = ('3009001', '3009003', '3009005', '3009007', '3009009', '3009011', '3009021'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.03 = '3003003' or not(../nem:eArrest.09 = ('3009009', '3009013', '3009015', '3009017', '3009019', '3009023', '3009025', '3009027'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.04 != '' or not(../nem:eArrest.01 = ('3001003', '3001005')) or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.04 = '3004001') or count(../nem:eArrest.04) = 1">
...
<xsl:template match="nem:eArrest.07[. = '']" priority="1016" mode="M18">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="not(../nem:eArrest.01 = ('3001003', '3001005')) or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
...
<xsl:template match="nem:eArrest.07[. != '']" priority="1015" mode="M18">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eArrest.01 = ('3001003', '3001005')"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.09 != '') or ../nem:eArrest.01 = ('3001003', '3001005')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.03 = '3003005') or ../nem:eArrest.09 = ('3009001', '3009003', '3009005', '3009007', '3009009', '3009011', '3009021')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.03 = '3003003') or ../nem:eArrest.09 = ('3009009', '3009013', '3009015', '3009017', '3009019', '3009023', '3009025', '3009027')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.12 != '' or not(../nem:eArrest.01 = ('3001003', '3001005')) or ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.12 = '3012001') or count(../nem:eArrest.12) = 1">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eArrest.17 != '' or not(../nem:eArrest.01 = ('3001003', '3001005')) or not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230001'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.03 = ('3003001', '3003003', '3003005'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.07 = ('3007003', '3007005'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(../nem:eArrest.07 = '3007005')">
...
<xsl:template match="nem:eHistory.01[. = '3101009'][1]" priority="1000" mode="M19">
      <xsl:variable name="nemsisElements" select="../nem:eHistory.01"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eHistory.01) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eHistory.01) = 1">
...
<xsl:template match="nem:eVitals.VitalGroup[some $element in .//* satisfies normalize-space($element) != '']/nem:eVitals.01[. = '']" priority="1003" mode="M20">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eVitals.02 = '9923003'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eVitals.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eVitals.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eVitals.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:decimal(.) &lt;= 100 or not(@ETCO2Type = '3340003')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:decimal(.) &lt;= 100 or not(@ETCO2Type = '3340005')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". castable as xs:integer or not(@ETCO2Type = '3340001')">
...
<xsl:template match="nem:eVitals.22[. = '3322003'][1]" priority="1000" mode="M20">
      <xsl:variable name="nemsisElements" select="../nem:eVitals.22"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eVitals.22) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eVitals.22) = 1">
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.01[. = '']" priority="1009" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eMedications.02 = '9923003'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eMedications.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eMedications.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eMedications.02 = '9923003'">
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.03[. = '']" priority="1007" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="false()"/>
...
<xsl:template match="nem:eMedications.03[. != '' and @CodeType]" priority="1006" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [ERROR]-->
<xsl:choose>
         <xsl:when test="matches(., '^[0-9]{2,7}$') or @CodeType != '9924003'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(., '^[0-9]{2,7}$') or @CodeType != '9924003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000') or @CodeType != '9924005'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(., '^[0-9]{2,7}$') or . = ('116762002', '116795008', '116861002', '116865006', '180208003', '33389009', '71493000')">
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.04[. = '']" priority="1004" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eMedications.02 = '9923003'"/>
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.DosageGroup/nem:eMedications.05[. = '']" priority="1003" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../../nem:eMedications.02 = '9923003'"/>
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.DosageGroup/nem:eMedications.06[. = '']" priority="1002" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../../nem:eMedications.02 = '9923003'"/>
...
<xsl:template match="nem:eMedications.08[. = '3708031'][1]" priority="1001" mode="M21">
      <xsl:variable name="nemsisElements" select="../nem:eMedications.08"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eMedications.08) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eMedications.08) = 1">
...
<xsl:template match="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.10[. = '']" priority="1000" mode="M21">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eMedications.02 = '9923003'"/>
...
<xsl:template match="nem:eProcedures.ProcedureGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eProcedures.01[. = '']" priority="1004" mode="M22">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eProcedures.02 = '9923003'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eProcedures.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eProcedures.02 = '9923003'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eProcedures.02 = '9923003'">
...
<xsl:template match="nem:eProcedures.ProcedureGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eProcedures.03[. = '']" priority="1002" mode="M22">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="false()"/>
...
<xsl:template match="nem:eProcedures.07[. = '3907033'][1]" priority="1001" mode="M22">
      <xsl:variable name="nemsisElements" select="../nem:eProcedures.07"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../nem:eProcedures.07) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../nem:eProcedures.07) = 1">
...
<xsl:template match="nem:eProcedures.ProcedureGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eProcedures.10[. = '']" priority="1000" mode="M22">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eProcedures.02 = '9923003'"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230003'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="starts-with(., ../nem:eDisposition.05)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". != '' or not(ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230003'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '' or not(ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230009', '4230013'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'">
...
<xsl:template match="nem:eDisposition.20[. = ''][1]" priority="1010" mode="M23">
      <xsl:variable name="nemsisElements" select="../nem:eDisposition.20"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="../nem:eDisposition.20 != '' or not(ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230003'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eDisposition.20 != '' or not(ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.30 = ('4230001', '4230003'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.01 = ('3001003', '3001005'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.StrokeScaleGroup/nem:eVitals.29 = '3329005')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.CardiacRhythmGroup/nem:eVitals.03 = ('9901051', '9901053', '9901055', '9901057', '9901058'))">
...
<xsl:template match="nem:eDisposition.24[. = '4224001'][1]" priority="1007" mode="M23">
      <xsl:variable name="nemsisElements" select="../../nem:eDisposition.HospitalTeamActivationGroup/nem:eDisposition.24"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="count(../../nem:eDisposition.HospitalTeamActivationGroup) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../../nem:eDisposition.HospitalTeamActivationGroup) = 1">
...
<xsl:template match="nem:eDisposition.HospitalTeamActivationGroup[* != '']" priority="1006" mode="M23">
      <xsl:variable name="nemsisElements" select="nem:eDisposition.24, nem:eDisposition.25"/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="nem:eDisposition.24 != ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="nem:eDisposition.24 != ''">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="nem:eDisposition.25 != '' or nem:eDisposition.24 = '4224001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '4227001' or not(../nem:eDisposition.28 = ('4228001', '4228003', '4228005', '4228007'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '4227001' or not(../nem:eDisposition.29 = ('4229001', '4229003', '4229005', '4229007'))">
      ...
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test=". = '4227001' or ../nem:eDisposition.30 = ('', '4230011', '4230013')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '4227001' or ../nem:eDisposition.30 = ('', '4230011', '4230013')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". != '' or ../nem:eDisposition.27 != '4227001'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". = '4228001' or not(../nem:eDisposition.29 = ('4229001', '4229003', '4229005', '4229007'))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../nem:eDisposition.27 != '4227001'">
...
<xsl:template match="nem:eDisposition.32[. = '' or . = '4232013']" priority="1000" mode="M23">
      <xsl:variable name="nemsisElements" select="."/>
      <!--ASSERT [WARNING]-->
<xsl:choose>
         <xsl:when test="ancestor::nem:eDisposition/nem:eDisposition.IncidentDispositionGroup/nem:eDisposition.28 != '4228001'"/>
